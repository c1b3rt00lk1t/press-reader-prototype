const firebaseConfig_DEV = {
    ...
    databaseURL: "https://press-uploader-2-default-rtdb.europe-west1.firebasedatabase.app",
...
export const firebaseConfig = isDevelopment ? firebaseConfig_DEV : firebaseConfig_PRD;